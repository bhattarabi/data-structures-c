...
/*************** IT CAN BE TURNED IN FOR 50% CREDIT ******************/
   ...
   cout << d1 << endl;  // default format is NUMERIC, 2/2/2016
   Date::outputFormat(TEXT);
   cout << d1 << endl;  // February 2, 2016
   Date::outputFormat(DAYTEXT); 
   cout << d1 << endl;  // Tuesday, February 2, 2016
   Date::outputFormat(NUMERIC); 
   cout << d1 << endl;  // 2/2/2016
   Date::outputFormat(DAYNUMERIC); 
   cout << d1 << endl;  // Tuesday, 2/2/2016
